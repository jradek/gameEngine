...
public class MasterRenderer {
    ...
    private static final float SKY_RED = 0.8f;
    private static final float SKY_GREEN = 1.0f;
    private static final float SKY_BLUE = 1.0f;

    private static final float MAX_FOG_DENSITY = 0.004f;
    ...
    public void setFog(boolean enable) {
        fogDensity = enable ? MAX_FOG_DENSITY : 0f;
    }
